...
import getSwiftCliConfig from './getSwiftCliConfig';

class generate {
    constructor(args) {
        this.ui = new UI({});
        this.getSwiftCliConfig = getSwiftCliConfig();
        this.availableBluePrints = this.getSwiftCliConfig.blueprints.map(bp => bp.name);
    ...
    processArgs = args => {
        ...
        this.blueprint = this.getSwiftCliConfig.blueprints[this.availableBluePrints.indexOf(args[0])];
